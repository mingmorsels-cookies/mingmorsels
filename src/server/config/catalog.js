...
export const PRODUCT_CATALOG = {
  ...
  'strawberry_single': {
    ...
    name: 'Strawberry Muffin (Single Muffin)',
    category: 'muffin',
    price: 45,
    unit: '1 Muffin',
    stock: 40,
    rating: 4.8,
    description: 'Freshly baked delicious single strawberry muffin.'
  },
  'pinacolada': {
    id: 'pinacolada',
  ...
  'pinacolada_single': {
    ...
    name: 'Pinacolada Muffin (Single Muffin)',
    category: 'muffin',
    price: 45,
    unit: '1 Muffin',
    stock: 45,
    rating: 4.8,
    description: 'Freshly baked delicious single pinacolada muffin.'
  },
  'pineapple': {
    id: 'pineapple',
  ...
  'pineapple_single': {
    id: 'pineapple_single',
    name: 'Pineapple Muffin (Single Muffin)',
    category: 'muffin',
    price: 45,
    unit: '1 Muffin',
    stock: 45,
    rating: 4.7,
    description: 'Freshly baked delicious single pineapple muffin.'
  },
  'butterscotch': {
    id: 'butterscotch',
  ...
  'butterscotch_single': {
    ...
    name: 'Butterscotch Muffin (Single Muffin)',
    category: 'muffin',
    price: 45,
    unit: '1 Muffin',
    stock: 55,
    rating: 4.9,
    description: 'Freshly baked delicious single butterscotch muffin.'
  },
  'choco': {
    id: 'choco',
  ...
  'choco_single': {
    id: 'choco_single',
    name: 'Chocochip Muffin (Single Muffin)',
    category: 'muffin',
    price: 45,
    unit: '1 Muffin',
    stock: 90,
    rating: 5.0,
    description: 'Freshly baked delicious single chocochip muffin.'
  },
  'chocochip': {
    id: 'chocochip',
    name: 'Chocochip Muffin',
  ...
  'blackcurrant_single': {
    ...
    name: 'Blackcurrant Muffin (Single Muffin)',
    category: 'muffin',
    price: 45,
    unit: '1 Muffin',
    stock: 50,
    rating: 4.85,
    description: 'Freshly baked delicious single blackcurrant muffin.'
  },
