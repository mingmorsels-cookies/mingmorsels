...
const PRODUCT_VECTORS = {
  ...
  choco: { id: 'choco', name: 'Double Dark Choco Muffin', img: '/img-choco.png', price: 175, tags: ['rich', 'fudgy', 'milk', 'chocolate'], vector: { sweet: 4, crunch: 1, nut: 2, fruit: 1, chocolate: 5 } }
};
