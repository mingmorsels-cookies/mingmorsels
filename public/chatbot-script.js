        ...
        const BOT_RESPONSES = {
            all: { en: "Here is our complete handcrafted collection — <strong>6 Signature Artisan Cookies &amp; 5 Soft-Baked Muffins</strong>, baked fresh with 100% natural ingredients and gourmet flair:<br><br>🌰 <strong>Almond Rich Cookie</strong> — Slow-roasted whole almonds in buttery golden dough<br>🌹 <strong>Rose Petal Cookie</strong> — Fragrant dried rose petals with soothing cardamom<br>🌾 <strong>Oats Nuts Cookie</strong> — Wholesome rolled oats, walnuts, and seeds for natural sustained energy<br>🍊 <strong>Orange Peel Cookie</strong> — Zesty citrus refreshment paired with warm cinnamon<br>🧠 <strong>Walnut Cookies</strong> — Rich, buttery crunch packed with neuro-protective omega-3s<br>🍃 <strong>Sugarfree Walnut Cookies</strong> — 100% Sugar-free, guilt-free, sweetened with natural Stevia<br>🍓 <strong>Strawberry Muffin</strong> — Real farm strawberry coulis in a tender butter crumb<br>🍍 <strong>Pinacolada Muffin</strong> — Tropical pineapple tidbits &amp; toasted coconut flakes<br>🧈 <strong>Butterscotch Muffin</strong> — Warm caramelized brown butter with crunchy toffee drops and butterscotch praline<br>🍫 <strong>Chocochip Muffin</strong> — Decadent single-origin dark cocoa with melting chips<br>🫐 <strong>Blackcurrant Muffin</strong> — Whole wheat atta muffin bursting with antioxidant-rich currants<br><br>Tap any flavour card below to pick your box size and add to cart! ✨" },
        ...
        const COOKIES = {
            ...
            walnut_sf: { 
                ...
                color: "#EBF5EB", 
                review: "100% Zero Added Sugar! Sweetened exclusively with natural plant Stevia extract and filled with roasted crunchy walnuts. Guilt-free, wholesome, and keto-compliant.", 
                rating: 4.5,
                reviewsCount: 88,
                stars: 5, 
                price: 150, 
                nutrition: { Calories: "128 kcal", Carbs: "9g", Protein: "4.8g", Fat: "8.2g", Sugar: "0g", Fibre: "3.5g", Sodium: "32mg", Preservatives: "None" }, 
                tags: ["100% Sugar Free", "Natural Stevia", "Zero Added Sugar", "Keto Approved"],
                boxes: [
        ...
        function getBotReply(userMsg) {
            ...
            if (/diabetic|sugar free|no sugar|blood sugar|zero sugar|stevia|keto|मधुमेह|ಮಧುಮೇಹ|நீரிழிவு|మధుమేహ|diabétique|سكري/.test(q)) return { text: { en: "For our health-conscious & keto friends, our 100% Zero Added Sugar option:", hi: "100% बिना चीनी, स्वास्थ्य व कीटो के लिए उपयुक्त:", kn: "100% ಸಕ್ಕರೆ ರಹಿತ, ಆರೋಗ್ಯ ಹಾಗೂ ಕೀಟೋ ಸ್ನೇಹಿ:", ta: "100% சர்க்கரை இல்லாத, ஆரோக்கியம் மற்றும் கீட்டோ தேர்வு:", te: "100% చక్కెర లేని, ఆరోగ్యకరమైన మరియు కీటో ఎంపిక:", fr: "100% sans sucre ajouté pour le bien-être et céto:", ar: "خالٍ من السكر 100% للصحة وحمية الكيتو:" }[lang] || "For our health-conscious friends, our 100% Zero Added Sugar option:", card: 'walnut_sf' };
        ...
        async function submitQVCookieReview() {
            ...
            // Sync with backend API to store in database and notify admin portal
            try {
                await fetch('/api/reviews/submit', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json' },
                    body: JSON.stringify({
                        productId: currentQVKey || 'almond',
                        name: name,
                        rating: selectedQVRating || 5,
                        text: comment,
                        location: 'Bengaluru'
                    })
                });
            } catch (syncErr) {
                console.warn('Backend review sync notice:', syncErr);
            }
