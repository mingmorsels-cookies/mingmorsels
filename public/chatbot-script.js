        ...
        const COOKIES = {
            ...
            walnut: { 
                ...
                boxes: [
                    { id: 'walnut_snack_2pcs', name: 'Snack Pack', count: '2 Cookies', price: 50, img: '/box-classic.jpg' },
                    { id: 'walnut_classic_8pcs', name: 'Classic Box', count: '8 Cookies', price: 210, img: '/box-lush.jpg', popular: true },
                    { id: 'walnut_family_12pcs', name: 'Family Pack', count: '12 Cookies', price: 420, img: '/box-extra.jpg' }
                ]
            },
            walnut_sf: { 
                ...
                boxes: [
                    { id: 'walnut_sf_snack_2pcs', name: 'Snack Pack', count: '2 Cookies', price: 55, img: '/box-classic.jpg' },
                    { id: 'walnut_sf_classic_8pcs', name: 'Classic Box', count: '8 Cookies', price: 220, img: '/box-lush.jpg', popular: true },
                    { id: 'walnut_sf_family_12pcs', name: 'Family Pack', count: '12 Cookies', price: 440, img: '/box-extra.jpg' }
                ]
            },
            strawberry: { 
        ...
        function getBotReply(userMsg) {
            ...
            if (/box option|box options|box size|box sizes|different box|packaging option|pack size|snack pack|classic box|family pack|how many cookies|how many pieces|box choices/.test(q)) {
                return {
                    text: `📦 <strong>Available Box Sizes &amp; Packaging Tiers</strong><br><br>Every flavour is freshly baked and packed in 3 distinct brand box options:<br><br>• <strong>Snack Pack (2 Cookies / 2 Muffins)</strong>: Perfect for personal snacking &amp; on-the-go cravings (from ₹40).<br>• <strong>Classic Box (8 Cookies / 4 Muffins)</strong>: Our #1 Bestseller — ideal for teatime sharing &amp; family dessert (from ₹140).<br>• <strong>Family Pack (12 Cookies / 6 Muffins)</strong>: Luxury keepsake presentation box for celebrations &amp; gatherings (from ₹210).<br><br>Tap on any flavour card to pick your box size and add directly to your basket! ✦`,
